# Generated by Powerlevel10k configuration wizard on 2022-11-07 at 02:00 CST.
...
() {
  ...
  function p10k-on-pre-prompt() { p10k display '1'=show '2/left/time'=hide 'empty_line'=hide}
  function p10k-on-post-prompt() { p10k display '1'=hide '2/left/time'=show 'empty_line'=show}
